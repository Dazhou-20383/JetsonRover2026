...
class ToolExecutor:
    """
    A collection of tools for controlling the rover's movement and navigation.
    
    Each tool is designed for specific scenarios and should be used according to the guidelines provided in their descriptions. Proper use of these tools will ensure safe and efficient navigation while minimizing risks.
        """
    ...
    def turn_towards(self, direction: int):
        """
    ...
    def place_waypoint(self, x: float, y: float):
        """
